...
#SBATCH -t 0-16:00             #
#SBATCH -p public
#SBATCH -o outslurm/bop.gs21.%a.log 
...
SCRATCH=/scratch/sjpruitt/bop_umd_gs21       # permanent output files (pkl) land here
TEMP=/scratch/sjpruitt/bop_temp_gs21         # intermediate _arr/ directories land here
