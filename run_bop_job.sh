...
#SBATCH -t 0-16:00             #
#SBATCH -p public
#SBATCH -o outslurm/bop.kp14.%a.log 
...
SCRATCH=/scratch/sjpruitt/bop_umd_kp14       # permanent output files (pkl) land here
TEMP=/scratch/sjpruitt/bop_temp_kp14         # intermediate _arr/ directories land here
